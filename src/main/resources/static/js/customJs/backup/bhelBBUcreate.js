		...
		if (sides == "left") {
			...
			for (let x in secondArray) {
				...
				if (catgarray != null && catgarray.length > 0) {
					...
					bbuhtml +=
						...
						"_L' class='labell'><P> <B><I>" + secondArray[x].name + "</B></I>:" + secondArray[x].description + "</P>" +
						"<span id='qty'>Qty.: " + secondArray[x].quantity + "</span><span id='amt'> Total ammount: Rs. " + secondArray[x].ammount
						+ "</span><span id='rate'> Rate:" + secondArray[x].rate + "</span></div>";
					...
					for (let catg in catgarray) {
						...
						if (grandChildList != null && grandChildList.length > 0) {
							...
							subtxt_1 += "<Button id = 'handle_" + secondArray[x].value + "_" + catgarray[catg].value + "_L' ondblclick='toggleVisibility(&#39" + gChildId + x + "&#39)' class = 'subhandleL' value='" + catgarray[catg].value + "'> </Button>"
								+ "<div class='labell' id = 'label_" + secondArray[x].value + "_" + catgarray[catg].value + "_L' ><p><b><i>" + catgarray[catg].name + "</b></i>:" + catgarray[catg].description
								+ " <br>Qty.: " + catgarray[catg].quantity + " Total ammount: Rs.  " + catgarray[catg].ammount + " Rate:" + catgarray[catg].rate + "</p></div>";
								...
								if (grandChildList[gchild] != null) {
									...
									if (gGrandChildList != null && gGrandChildList.length > 0) {
										...
										grandchildtxt_1 += "<Button id = 'handle" + "_" + secondArray[x].value + "_" + catgarray[catg].value + "_" + grandChildList[gchild].value + "_" + "L' class = 'subhandleL' ondblclick='toggleVisibility(&#39ggrandchild" + ggChildId + x + "&#39)'> </Button>" +
											"<div class='labell' id = 'label" + "_" + secondArray[x].value + "_" + catgarray[catg].value + "_" + grandChildList[gchild].value + "_" + "L' ><p><b><i>" + grandChildList[gchild].name + "</b></i>:" + grandChildList[gchild].description
											+ " <br>Qty.:  " + grandChildList[gchild].quantity + " Total ammount: Rs.  " + grandChildList[gchild].ammount + " Rate:" + grandChildList[gchild].rate + "</p></div>";
										...
										for (let ggchild in gGrandChildList) {
											...
											let ggrandchildtxt = "<div id='HiddenDiv" + "_" + secondArray[x].value + "_" + catgarray[catg].value + "_"
												+ grandChildList[gchild].value + "_" + gGrandChildList[ggchild].value + "_" + "L' class='gGrandChildHiddenDivL' ondrop='drop(event)' ondragover='allowDrop(event)' style='top:" + ggrandchild_top + "px'>";
											ggrandchildtxt += "<Button id = 'handle" + "_" + secondArray[x].value + "_" + catgarray[catg].value + "_"
												+ grandChildList[gchild].value + "_" + gGrandChildList[ggchild].value + "_" + "L' class = 'subhandleL' value='"
												+ gGrandChildList[ggchild].name + "'> </Button>" + "<div class='labell' id = 'label_" + secondArray[x].value + "_" + catgarray[catg].value + "_" + grandChildList[gchild].value + "_" + gGrandChildList[ggchild].value + "_L' ><p><b><i>" + gGrandChildList[ggchild].name + "</b></i>:" + gGrandChildList[ggchild].description
										...
										grandchildtxt_1 += "<Button id = 'handle_" + secondArray[x].value + "_" + catgarray[catg].value + "_" + grandChildList[gchild].value + "_L' class = 'subhandleL' value='" + grandChildList[gchild].value + "' ondblclick='toggleVisibility(&#39ggrandchild" + ggChildId + "&#39)'> </Button>" +
											"<div class='labell' id = 'label_" + secondArray[x].value + "_" + catgarray[catg].value + "_" + grandChildList[gchild].value + "_L' ><p><b><i>" + grandChildList[gchild].name + "</b></i>:" + catgarray[catg].description + " <br>Qty.: "
											+ grandChildList[gchild].quantity + " Total ammount: Rs.  " + grandChildList[gchild].ammount + " Rate:" + grandChildList[gchild].rate + "</p></div>";
										grandchildtxt_1 += "</div>";
										grandchildtxt += grandchildtxt_1;
					...
					bbuhtml += "<Button id = 'handle" + secondArray[x].value + "L' class = 'handleL' value='" + secondArray[x].value + "'></button><div id = 'parentlabel" + x + "L' class='labell'><p><b><i>" + secondArray[x].name + "</b></i>:" + secondArray[x].description
						+ "<br>Qty.: " + secondArray[x].quantity + " Total ammount: Rs.  " + secondArray[x].ammount + " Rate:" + secondArray[x].rate + "</p></div>";
				}
			...
			for (let target in targetArray) {
				...
				if (rightsubcategorry != null && rightsubcategorry.length > 0) {
					...
					textRight += "<Button id = 'parentHandle" + target + "R' class = 'handleR' value='" + targetArray[target].value + "' ondblclick='toggleVisibility(&#39" + id.trim() + "&#39)'></button><div id = 'parentLabel" + target + "R' class='labelR'><p><b><i>" + targetArray[target].name + "</b></i>:" + targetArray[target].description
						+ " <br>Qty.: " + targetArray[target].quantity + ", Total ammount: Rs. " + targetArray[target].ammount + ", Rate:" + targetArray[target].rate + "</p></div>";
					...
					for (let catg in rightsubcategorry) {
						...
						if (rightGrandChild != null && rightGrandChild.length > 0) {
							...
							subtxtRight_1 += "<Button id = 'handle_" + targetArray[target].value + "_" + rightsubcategorry[catg].value + "_R' class = 'handleR' ondblclick='toggleVisibility(&#39grandchildHiddenDiv" + catg + rightsubcategorry[catg].value + "R&#39)' value='" + rightsubcategorry[catg].value + "'> </Button><div id = 'childLabel" + catg + "R' ><p><b><i>" + rightsubcategorry[catg].name + "</b></i>:" + rightsubcategorry[catg].description
								+ " <br>Qty.: " + rightsubcategorry[catg].quantity
								+ " Total ammount: Rs. " + rightsubcategorry[catg].ammount + " Rate: " + rightsubcategorry[catg].rate + "</p></div>";
							...
							for (let rGrandChild in rightGrandChild) {
								...
								rGrandChild_1 += "<Button id = 'handle_" + target + "." + rGrandChild + "_R' class = 'handleR' value='" + rightGrandChild[rGrandChild].value + "'> </Button><div id = 'gchildlabel" + rGrandChild + "R' ><p><b><i>" + rightGrandChild[rGrandChild].name + "</b></i>:" + rightGrandChild[rGrandChild].description
									+ " <br>Qty.: "
									+ rightGrandChild[rGrandChild].quantity + " Total ammount: Rs. " + rightGrandChild[rGrandChild].ammount + " Rate:"
									+ rightGrandChild[rGrandChild].rate + "</p></div>";
								rGrandChild_1 += "</div>";
					...
					textRight += "<Button id = 'Handle_" + targetArray[target].value + "_R' class = 'handleR' value='" + targetArray[target].value + "'></button><div id = 'Label_" + targetArray[target].value + "_R' class='labelR'><p><b><i>" + targetArray[target].name + "</b></i>:" + targetArray[target].description
						+ " <br>Qty.: " + targetArray[target].quantity + ", Total ammount: Rs. " + targetArray[target].ammount + ", Rate:" + targetArray[target].rate + "</p></div>";
				}
				textRight += "</div>";
